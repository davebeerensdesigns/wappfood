...
VALUES
(localtimestamp, localtimestamp, '<p>This is a product description. It should only allow HTML.</p>', 'Avocado Nigiri', 1.50, 'NIG001', 'avocado-nigiri', 50, 'Standaard', true, 0, 1),
(localtimestamp, localtimestamp, '<p>This is a product description. It should only allow HTML.</p>', 'Zalm Nigiri', 1.60, 'NIG002', 'avocado-nigiri', 50, 'Standaard', true, 0, 1);